...
//https://leetcode.com/problems/find-and-replace-in-string/discuss/2076687/Sort-in-Descending-Order-and-traverse-C%2B%2B

// Good Solution to replace in reverse order
// class Solution {
// public:
//     string findReplaceString(string s, vector<int>& indices, vector<string>& sources, vector<string>& targets) {
